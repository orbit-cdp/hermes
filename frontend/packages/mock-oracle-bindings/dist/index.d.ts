...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDIIDS3LAMDTBUO6I5HK5J4CWF4H7MA3BY4SIJDAFTHLSLQ5OTBAPHJQ";
    };
};
/**
...
export interface Client {
     ...
     */
    set_data: ({ admin, base, assets, decimals, resolution }: {
        admin: string;
        base: Asset;
        assets: Array<Asset>;
        decimals: u32;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        set_data: (json: string) => AssembledTransaction<null>;
        set_price: (json: string) => AssembledTransaction<null>;
        set_price_stable: (json: string) => AssembledTransaction<null>;
